...
<div class="relative overflow-x-hidden">
    ...
    <section id="hero" class="pt-36 xl:pt-54 bg-linear-to-b from-[#2B4E43]/40 to-[#132620]/90 to-28% relative">
        <div class="max-w-7xl mx-auto px-6 xl:px-12 relative">
            ...
            <div class="mt-8 flex flex-wrap gap-8 relative z-10">
            ...
            <div class="absolute -bottom-72 -right-84 xl:-bottom-75 xl:-right-92">
                <img src="/Wrist Watch.K02.2k Copy.webp" class="w-144 xl:w-219" loading="lazy">
            </div>
        </div>
        <div class="max-w-7xl mx-auto px-6 xl:px-12 relative pt-72 pb-36">
            <h2 class="text-center font-heading max-w-3xl text-[3rem]/13 xl:text-[3.25rem]/15 mx-auto font-bold">Trusted by collectors worldwide. Vetted by experts.</h2>
            <div class="flex items-center text-center xl:text-left justify-center gap-x-10 gap-y-4 mt-12 flex-wrap text-sm font-medium">
                <p>Sellers with 20+ years of specialized expertise</p>
                <p>Specialists in Swiss watches, Hermès, and <span class="whitespace-nowrap">rare cameras</span></p>
            ...
            <div class="bg-[#AA9772] pt-36 xl:pt-36 pb-36 xl:pb-58 text-[#FFFBEB]">
                <div class="relative flex">
                    <div class="bg-[#AA9772] relative px-5 py-3 z-10 pl-18 ">
                        ...
                        <h3 class="font-heading text-[3rem]/13 xl:text-[3.5rem]/15.5 font-bold max-w-xl">Every item authenticated by certified specialists</h3>
                        <p class="mt-8 text-base/8 xl:text-lg/7.5 max-w-xl font-medium">Each listing comes from a vetted expert—whether it's a Swiss-certified watchmaker, a Parisian-trained Hermès specialist, or a collector with three decades of experience. You'll know exactly who curated your piece and why it's authentic.</p>
                    </div>
                ...
                <div class="relative mt-82 flex flex-row-reverse">
                    <div class="pr-18 bg-[#AA9772] relative z-10 px-5 py-3">
                        <div class="absolute top-35 -right-18">
                            <h2 class="text-sm uppercase font-semibold tracking-[0.3em] rotate-90">Curated Selection</h2>
                        </div>
                        <h3 class="font-heading text-[3rem]/13 xl:text-[3.5rem]/15.5 font-bold max-w-150">Only the finest pieces make it through our doors</h3>
                ...
                <div class="relative flex mt-82">
                    <div class="bg-[#AA9772] relative px-5 py-3 z-10 pl-18 ">
                        ...
                        <h3 class="font-heading text-[3rem]/13 xl:text-[3.5rem]/15.5 font-bold max-w-xl">Connect directly with the expert who curated <span class="whitespace-nowrap">your item</span></h3>
                        <p class="mt-8 text-base/8 xl:text-lg/7.5 max-w-150 font-medium">
    ...
    <section class="py-80 bg-[#132620]/90 relative">
        <div class="max-w-7xl mx-auto px-6 xl:px-12 relative">
            <h2 class="font-heading text-[3rem]/13 xl:text-[3.25rem]/15 max-w-158 font-bold text-center mx-auto">Find your next treasure. Or share yours with the world.</h2>
    ...
    <footer class="bg-[#132620]/90 pt-24 pb-6 relative">
        <div class="max-w-7xl mx-auto px-4 xl:px-12 flex flex-col-reverse gap-y-4 xl:flex-row justify-between items-center">
            <div>
                <a href="{{ route('home') }}" wire:navigate>
                    <svg width="178px" height="58px" viewBox="0 0 178 58" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
